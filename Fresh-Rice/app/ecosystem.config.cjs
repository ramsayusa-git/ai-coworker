...
module.exports = {
  apps: [
    { name: 'freshrice-mcp', cwd: __dirname + '/apps/mcp', script: 'dist/index.js', args: '--http', env: { NODE_ENV: 'production', MCP_PORT: '4300', FRESHRICE_API_URL: 'http://localhost:4100', FRESHRICE_API_KEY: 'frk_fb2nHrF7FlCfumW57V6JubmxEEjckwVG', MCP_BEARER: 'IrsDgL6wCTcQS0OLeB9Vc60c' }, max_memory_restart: '300M', time: true },
    {
      name: 'freshrice-api',
