...
mv aetos-one-rpi4-build-v7.2.img.xz aetos-one-rpi4-build-v9.8.2.img.xz && echo "renamed -> v9.8.2"
...
echo "=== verify v9.8.2 xz ==="
xz -t aetos-one-rpi4-build-v9.8.2.img.xz && echo "XZ-OK v9.8.2" || echo "XZ-FAIL"
...
ls -lh aetos-one-rpi4-build-v9.8.2.img.xz
