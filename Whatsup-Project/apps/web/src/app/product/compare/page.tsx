...
export const metadata = { title: "Compare — Aetos One Chat vs Wati, AiSensy, Interakt, Gallabox, Twilio" };
    ...
    <MarketingShell>
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="max-w-2xl">
          <p className="text-sm font-semibold uppercase tracking-wide text-emerald-600">Compare</p>
          <h1 className="mt-2 text-3xl font-bold sm:text-4xl">Aetos One Chat vs. the market</h1>
          <p className="mt-3 text-zinc-600">
            Condensed from a module-by-module benchmark against 10 WhatsApp platforms worldwide —
            India SaaS (Wati, AiSensy, Interakt, Gallabox) and enterprise CPaaS (Twilio). ● full ·
            ◐ partial / higher tier · ○ none.
          </p>
        </div>
